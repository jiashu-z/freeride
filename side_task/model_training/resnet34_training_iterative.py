...
class Resnet34TrainingIterativeTask(IterativeTask):
    ...
    def submitted_to_created(self) -> None:
        ...
        self.model = models.resnet34(weights=models.ResNet34_Weights.IMAGENET1K_V1).to(
            self.device
        )
