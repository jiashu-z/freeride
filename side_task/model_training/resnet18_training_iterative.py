...
class Resnet18TrainingIterativeTask(IterativeTask):
    ...
    def submitted_to_created(self) -> None:
        ...
        self.model = models.resnet18(weights=models.ResNet18_Weights.IMAGENET1K_V1).to(
            self.device
        )
